...
// counted. A guess sent faster than a person could flags the round; see
// FASTEST_GUESS_MS in _lib/game.js.
...
export default endpoint("POST", async ({ body }) => {
  // Before anything slow, and once, so a retried write keeps the true time.
  const at = Date.now();
