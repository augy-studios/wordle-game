...
// 404.html has not been brought onto the theme system yet. Take it out of
// this list once it has.
const NOT_YET = new Set(["404.html"]);

const failures = [];
const pages = readdirSync(ROOT).filter((f) => f.endsWith(".html") && !NOT_YET.has(f));
